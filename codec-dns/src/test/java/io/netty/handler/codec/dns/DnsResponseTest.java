...
public class DnsResponseTest {
    ...
    public void readResponseTest() throws Exception {
        ...
        for (byte[] p: packets) {
            ...
            assertThat(response.questionCount(), is(raw.getUnsignedShort(4)));
            assertThat(response.answerCount(), is(raw.getUnsignedShort(6)));
            assertThat(response.authorityRecordCount(), is(raw.getUnsignedShort(8)));
            assertThat(response.additionalRecordCount(), is(raw.getUnsignedShort(10)));
