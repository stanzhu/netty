...
public class DnsQueryTest {
    ...
    public void writeQueryTest() throws Exception {
        ...
        queries.add(new DatagramDnsQuery(addr, null, 1).setQuestion(
        ...
        for (DnsQuery query: queries) {
            assertThat(query.questionCount(), is(1));
            assertThat(query.answerCount(), is(0));
            assertThat(query.authorityRecordCount(), is(0));
            assertThat(query.additionalRecordCount(), is(0));
