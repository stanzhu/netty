...
public class DefaultDnsRecordDecoder implements DnsRecordDecoder {
    ...
    public DnsQuestion decodeQuestion(ByteBuf in) throws Exception {
        ...
        DnsRecordClass qClass = DnsRecordClass.valueOf(in.readUnsignedShort());
    ...
    public <T extends DnsRecord> T decodeRecord(ByteBuf in) throws Exception {
        ...
        final DnsRecordClass aClass = DnsRecordClass.valueOf(in.readUnsignedShort());
    ...
    protected DnsRecord decodeRecord(
            String name, DnsRecordType type, DnsRecordClass dnsClass, long timeToLive,
